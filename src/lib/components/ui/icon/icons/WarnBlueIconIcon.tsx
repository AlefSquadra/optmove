...
export const WarnBlueIconIcon: React.FC<IconProps> = ({ color = "#000000", width = "24", height = "24", ...props }) => {
  return (
    <Icon width={width} height={height} viewBox="0 0 24 24" {...props}>
      <g xmlns="http://www.w3.org/2000/svg" clip-path="url(#clip0_1979_23205)">
        <path
